class Solution:
    def trap(self, height: List[int]) -> int: 
        # Two-pointer version. No need for array, just maxes.
        # Greedy approach: the lower of the highest wall of left vs right is the limiting
        # height of trapping rain water.
